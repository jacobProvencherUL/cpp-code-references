...
${OBJECTDIR}/Carre.o: Carre.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Carre.o Carre.cpp
...
${OBJECTDIR}/Polygone.o: Polygone.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Polygone.o Polygone.cpp
...
${TESTDIR}/tests/CarreTesteur.o: tests/CarreTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CarreTesteur.o tests/CarreTesteur.cpp


${TESTDIR}/tests/PointTesteur.o: tests/PointTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PointTesteur.o tests/PointTesteur.cpp


${TESTDIR}/tests/PolygoneTesteur.o: tests/PolygoneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PolygoneTesteur.o tests/PolygoneTesteur.cpp


${TESTDIR}/tests/RectangleTesteur.o: tests/RectangleTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RectangleTesteur.o tests/RectangleTesteur.cpp


${TESTDIR}/tests/TriangleTesteur.o: tests/TriangleTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TriangleTesteur.o tests/TriangleTesteur.cpp
...
${OBJECTDIR}/Carre_nomain.o: ${OBJECTDIR}/Carre.o Carre.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Carre_nomain.o Carre.cpp;\
	else  \
...
${OBJECTDIR}/Polygone_nomain.o: ${OBJECTDIR}/Polygone.o Polygone.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Polygone_nomain.o Polygone.cpp;\
	else  \
...
${OBJECTDIR}/Rectangle_nomain.o: ${OBJECTDIR}/Rectangle.o Rectangle.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rectangle_nomain.o Rectangle.cpp;\
	else  \
...
${OBJECTDIR}/Triangle_nomain.o: ${OBJECTDIR}/Triangle.o Triangle.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Triangle_nomain.o Triangle.cpp;\
	else  \
