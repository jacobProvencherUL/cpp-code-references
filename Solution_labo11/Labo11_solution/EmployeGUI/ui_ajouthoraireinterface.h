...
public:
    ...
    {
        AjoutHoraireInterfaceClass->setWindowTitle(QApplication::translate("AjoutHoraireInterfaceClass", "AjoutHoraireInterface", 0, QApplication::UnicodeUTF8));
        label_titre->setText(QApplication::translate("AjoutHoraireInterfaceClass", "AJout d'un employe horaire", 0, QApplication::UnicodeUTF8));
        pushButton_valideHoraire->setText(QApplication::translate("AjoutHoraireInterfaceClass", "Enregistrer nouvel employe", 0, QApplication::UnicodeUTF8));
        label_departement->setText(QApplication::translate("AjoutHoraireInterfaceClass", "Departement :", 0, QApplication::UnicodeUTF8));
        label_tauxHoraire->setText(QApplication::translate("AjoutHoraireInterfaceClass", "Taux horaire :", 0, QApplication::UnicodeUTF8));
        label_prenom->setText(QApplication::translate("AjoutHoraireInterfaceClass", "Prenom :", 0, QApplication::UnicodeUTF8));
        label_nom->setText(QApplication::translate("AjoutHoraireInterfaceClass", "Nom :", 0, QApplication::UnicodeUTF8));
        dateEdit->setDisplayFormat(QApplication::translate("AjoutHoraireInterfaceClass", "dd-MM-yyyy", 0, QApplication::UnicodeUTF8));
        label_dateNaissance->setText(QApplication::translate("AjoutHoraireInterfaceClass", "Date de naissance :", 0, QApplication::UnicodeUTF8));
        label_nombreHeure->setText(QApplication::translate("AjoutHoraireInterfaceClass", "Nombre heures :", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
