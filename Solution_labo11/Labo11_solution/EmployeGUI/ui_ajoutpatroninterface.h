...
public:
    ...
    {
        AjoutPatronInterfaceClass->setWindowTitle(QApplication::translate("AjoutPatronInterfaceClass", "AjoutPatronInterface", 0, QApplication::UnicodeUTF8));
        label_prenom->setText(QApplication::translate("AjoutPatronInterfaceClass", "Prenom :", 0, QApplication::UnicodeUTF8));
        label_titre->setText(QApplication::translate("AjoutPatronInterfaceClass", "AJout d'un patron", 0, QApplication::UnicodeUTF8));
        dateEdit->setDisplayFormat(QApplication::translate("AjoutPatronInterfaceClass", "dd-MM-yyyy", 0, QApplication::UnicodeUTF8));
        pushButton_validePatron->setText(QApplication::translate("AjoutPatronInterfaceClass", "Enregistrer nouvau patron", 0, QApplication::UnicodeUTF8));
        label_nom->setText(QApplication::translate("AjoutPatronInterfaceClass", "Nom :", 0, QApplication::UnicodeUTF8));
        label_salaireHebdo->setText(QApplication::translate("AjoutPatronInterfaceClass", "Salaire hebdo :", 0, QApplication::UnicodeUTF8));
        label_departement->setText(QApplication::translate("AjoutPatronInterfaceClass", "Departement :", 0, QApplication::UnicodeUTF8));
        label_dateNaissance->setText(QApplication::translate("AjoutPatronInterfaceClass", "Date de naissance :", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
