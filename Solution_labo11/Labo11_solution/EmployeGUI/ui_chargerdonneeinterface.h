...
public:
    ...
    {
        ChargerDonneeInterfaceClass->setWindowTitle(QApplication::translate("ChargerDonneeInterfaceClass", "ChargerDonneeInterface", 0, QApplication::UnicodeUTF8));
        label_titre->setText(QApplication::translate("ChargerDonneeInterfaceClass", "Charger les donnees", 0, QApplication::UnicodeUTF8));
        pushButton_saveDonnee->setText(QApplication::translate("ChargerDonneeInterfaceClass", "Charger les donnees", 0, QApplication::UnicodeUTF8));
        label_nom->setText(QApplication::translate("ChargerDonneeInterfaceClass", "Nom du fichier :", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
