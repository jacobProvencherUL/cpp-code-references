...
public:
    ...
    {
        EmployeGUIClass->setWindowTitle(QApplication::translate("EmployeGUIClass", "Gestion Employe GIF-1003", 0, QApplication::UnicodeUTF8));
        actionCharger_a_partir_de->setText(QApplication::translate("EmployeGUIClass", "Charger a partir de ..", 0, QApplication::UnicodeUTF8));
        actionSauvegarder_dans->setText(QApplication::translate("EmployeGUIClass", "Sauvegarder dans ...", 0, QApplication::UnicodeUTF8));
        actionCommis->setText(QApplication::translate("EmployeGUIClass", "Commis", 0, QApplication::UnicodeUTF8));
        actionHoraire->setText(QApplication::translate("EmployeGUIClass", "Horaire", 0, QApplication::UnicodeUTF8));
        actionPatron->setText(QApplication::translate("EmployeGUIClass", "Patron", 0, QApplication::UnicodeUTF8));
        actionCommis_sup->setText(QApplication::translate("EmployeGUIClass", "Commis", 0, QApplication::UnicodeUTF8));
        actionHoraire_sup->setText(QApplication::translate("EmployeGUIClass", "Horaire", 0, QApplication::UnicodeUTF8));
        actionPatron_sup->setText(QApplication::translate("EmployeGUIClass", "Patron", 0, QApplication::UnicodeUTF8));
        actionExit->setText(QApplication::translate("EmployeGUIClass", "Exit", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("EmployeGUIClass", "Nom", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("EmployeGUIClass", "Prenom", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("EmployeGUIClass", "Date de naissance", 0, QApplication::UnicodeUTF8));
        menuFichier->setTitle(QApplication::translate("EmployeGUIClass", "Fichier", 0, QApplication::UnicodeUTF8));
        menuActions->setTitle(QApplication::translate("EmployeGUIClass", "Actions", 0, QApplication::UnicodeUTF8));
        menuAjouter_un_employer->setTitle(QApplication::translate("EmployeGUIClass", "Ajouter un employer", 0, QApplication::UnicodeUTF8));
        menuSupprimer_un_employe->setTitle(QApplication::translate("EmployeGUIClass", "Supprimer un employe", 0, QApplication::UnicodeUTF8));
        toolBar->setWindowTitle(QApplication::translate("EmployeGUIClass", "toolBar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
