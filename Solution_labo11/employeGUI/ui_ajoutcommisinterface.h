...
public:
    ...
    void setupUi(QDialog *AjoutCommisInterfaceClass)
    {
        ...
        QObject::connect(pushButton, SIGNAL(clicked()), AjoutCommisInterfaceClass, SLOT(valideEnregistrement()));
    ...
    void retranslateUi(QDialog *AjoutCommisInterfaceClass)
    {
        ...
        label_dateNaissance->setText(QApplication::translate("AjoutCommisInterfaceClass", "Date de naissance :", nullptr));
        label_commission->setText(QApplication::translate("AjoutCommisInterfaceClass", "Commission :", nullptr));
        pushButton->setText(QApplication::translate("AjoutCommisInterfaceClass", "Valider le nouvel employe", nullptr));
        label_codeDepartement->setText(QApplication::translate("AjoutCommisInterfaceClass", "Code de departement :", nullptr));
        label_titre->setText(QApplication::translate("AjoutCommisInterfaceClass", "AJout d\342\200\231un employe commission", nullptr));
