...
public:
    ...
    {
        SupprimerCommisInterfaceClass->setWindowTitle(QApplication::translate("SupprimerCommisInterfaceClass", "SupprimerCommisInterface", nullptr));
        label_prenom->setText(QApplication::translate("SupprimerCommisInterfaceClass", "Prenom :", nullptr));
        label_titre->setText(QApplication::translate("SupprimerCommisInterfaceClass", "Suppression d'un employe", nullptr));
        pushButton->setText(QApplication::translate("SupprimerCommisInterfaceClass", "Valider suppression", nullptr));
        label_nom->setText(QApplication::translate("SupprimerCommisInterfaceClass", "Nom :", nullptr));
    } // retranslateUi
