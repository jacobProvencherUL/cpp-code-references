...
TEST_F(UnEmployeCommission,reqEmployeFormate)
{
	...
	os << std::endl << " Employé à commission: " << std::endl;
	os << unEmployeCommis.reqPrenom()<< " " << unEmployeCommis.reqNomFamille() << std::endl;
	os << "Date de naissance : " << unEmployeCommis.reqDateNaissance() << std::endl;
	os << "Salaire : " << unEmployeCommis.reqSalaire() << std::endl;
	os << "Commission : " << unEmployeCommis.reqCommission() << std::endl;
	os << "Quantite vendue : " << unEmployeCommis.reqQuantite() << std::endl;
	os << "Code de departement : " << unEmployeCommis.reqCodeDepartement() << std::endl;
	os << "Les gains : " << unEmployeCommis.gains() << std::endl;
