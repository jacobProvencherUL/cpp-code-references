...
TEST_F(PatronTest,reqEmployeFormate)
{
	...
	os << unPatron.reqPrenom() << " " << unPatron.reqNomFamille() << std::endl;
	os << "Date de naissance : " << unPatron.reqDateNaissance() << std::endl;
	os << "Salaire : " << 800.00 << std::endl;
	os << "Code de departement : " << unPatron.reqCodeDepartement() << std::endl;
